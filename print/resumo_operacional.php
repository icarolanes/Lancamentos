  ...
  <tbody>
    ...
    while ($docs = $prep_doc->fetch()){
      ...
      <tr>
        ...
        <td colspan="<?php echo $poroes['poroes'];?>">BL do produto</td>
        <td colspan="2"><?php $soma_manif = $soma_manif+$docs['manifestado']; echo numero($docs['manifestado'])?></td>
        <td colspan="1"><?php $soma_desc = $soma_desc+$docs['descarregado']; echo numero($docs['descarregado'])?></td>
        <td colspan="1"><?php $quebra = $docs['manifestado']-$docs['descarregado']; $soma_quebra = $soma_quebra+($quebra); echo numero($quebra)?></td>
      </tr>
      <?php
    }
    ?>
    ...
    <tr class="obs">
      ...
      <td colspan="<?php echo $poroes['poroes']+2;?>"><h4>Assinatura/Carimbo do Gerente ou Fiel Depositário e do Comando do navio</h4></td>
    </tr>
  </tbody>
</table>
