...
//Select dados de atracação
    ...
    $atracacao_dados = "SELECT navio as navio, Natraca as numero, Datracacao as atracacao, Ddesatracacao as desatracacao, ope1 as inicio_ope, ope2 as termino_ope,timediff(ope2,ope1) as Toperacao , timediff(Ddesatracacao, Datracacao) as Tatracacao from atracacao;";
