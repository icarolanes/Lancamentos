    ...
    <div class="container-sm col-sm-12 col-md-10">
        <form class="row g-2" method="post" action="banco/lanc_enviar.php">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" placeholder="nome do navio" disabled
                    value="<?php echo $navio?>">
                <input readonly type="number" class="form-control" name="atra" hidden placeholder="id atracacao"
                    value="<?php echo $_GET['n']?>">
            </div>
            <div class="col-md-4">
            ...
            ?>
                <input readonly type="text" class="form-control" value="<?php echo $documento['identificacao']?>"
                    placeholder="Documento">
                <input readonly type="text" class="form-control" hidden name="doc" value="<?php echo $documento['id']?>"
                    placeholder="Documento">
            </div>
            <div class="col-md-4">
                ...
                <select id="tp_ope" class="form-select" name="tp">
                    <?php
    //puxar lista de operações
              $sel_tp_ope = "SELECT * FROM tipo_lancamento order by ordem;  ";
              $sel=$con->prepare($sel_tp_ope);
              $sel->execute();
              while ($operacoes = $sel->fetch()) {
                echo "<option value='".$operacoes['id']."'>".$operacoes['nTipo']."</option>";
              }
              ?>
                </select>
            </div>
...
//$cavalo_final = $cavalo;
            ?>
                <input readonly type="text" class="form-control" value="<?php echo $cavalo_final['id']?>"
                    placeholder="placa" hidden name="placa">
                <input readonly type="text" class="form-control" value="<?php echo $cavalo_final['placa']?>" id="placa"
                    placeholder="placa">
            </div>
            <div class="col-md-2">
            ...
            ?>
                <input type="text" class="form-control" name="carreta[]" minlength="7" maxlength="7" id="placa1"
                    value="<?php echo $carreta_car['placa']?>" placeholder="Carreta 1" required>
            </div>
            <div class="col-md-2">
            ...
            ?>
                <input type="text" name="cpf" class="form-control" id="cpf" value="<?php echo $cpf_mot;?>"
            ...
            ?>
                <input class="form-control" list="transplist" id="transp" name="transportadora"
                    value="<?php echo $cnpj_transp;?>" required aria-label="transp">
