    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class=" col-sm-12 col-md-12">
            <form oninput="separa_dados(); busca_cnpj();" onfocusin="separa_dados();" class="row g-2" method="post"
                action="banco/lanc_enviar.php">
                <div class="col-md-12 col-lg-12 mb-3">
                    <label for="chaveNota" class="form-label">Chave da NF</label>
                    <input type="text" class="form-control" id="chaveNota" value="<?php echo $key ;?>" maxlength="44"
                        autofocus>
                ...
                <div class="col-md-3 col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control" id="cnpj_cad" readonly>
                </div>
                <div class="col-md-2 col-lg-1 mb-3">
