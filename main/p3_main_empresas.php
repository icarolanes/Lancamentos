      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#cadastro_empresa" accesskey="n">Novo</button>
          </div>
        </div>
      </div>
      <?php 
            ...
            <div class="modal-body">
              <form method="post" id="form_cad_emp" action="a.php">
                <div class="mb-3">
                  ...
                  <input type="text" oninput="cnpj_buscar(value);" class="form-control" id="cnpj_cad" name="cnpj_cad" maxlength="18" autocomplete="off">
                ...
                <div class="mb-3">
                  <label for="desclog" class="form-label">Tipo Logradrouro</label>
                  <input type="text" class="form-control" id="desclog" name="desclog" readonly>
                </div>
                <div class="mb-3">
