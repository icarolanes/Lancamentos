        ...
        <div
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    <button type="button" onclick="window.location.href='index.php?p=15'"
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link"
                            href="index.php?<?php echo "p=".$_GET['p']."&page=". $navant ?>">Anterior
                        </a></li>
                    <?php  
//paginação
    ...
    for ($i=0; $i < $pages ; $i++) { 
      ?>
                    <li class="page-item"><a class="page-link"
                            href="index.php?<?php echo "p=".$_GET['p']."&page=". $nav ?>"><?php echo $nav++ ?></a></li>
                    <?php  
    }
    ?>
                    <li class="page-item"><a class="page-link"
                            href="index.php?<?php echo "p=".$_GET['p']."&page=". $navprox ?>">Proxima</a></li>
                </ul>
            </nav>
        </div>
    </main>
                    ...
                    <form id="xmlform" action="#" enctype="multipart/form-data" method="post">
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-sm" type="file" name="fileToUpload[]"
                                id="formFileSm" multiple="multiple">
                        </div>
