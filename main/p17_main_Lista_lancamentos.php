        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item"><a class="page-link"
                        href="index.php?<?php echo "p=".$_GET['p']."&n=".$_GET['n']."&page=". $navant ?>">Anterior
                    </a></li>
                <?php  
//paginação
              ...
              for ($i=0; $i < $pages ; $i++) { 
                ?>
                <li class="page-item"><a class="page-link"
                        href="index.php?<?php echo "p=".$_GET['p']."&n=".$_GET['n']."&page=". $nav ?>"><?php echo $nav++ ?></a>
                </li>
                <?php  
              }
              ?>
                <li class="page-item"><a class="page-link"
                        href="index.php?<?php echo "p=".$_GET['p']."&n=".$_GET['n']."&page=". $navprox ?>">Proxima</a>
                </li>
            </ul>
        </nav>
    </div>
            ...
            <div class="modal-content">
                    ...
                    <form id="man" method="post" action="<?php echo $action;?>">
                      ...
                      ?>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input required class="form-control" list="datalistOptions" id="exampleDataList" name="pl"
                                placeholder="Placa - Realize consulta de ultimas placas nesse navio" minlength="7"
                                maxlength="7" aria-label="Placa" autocomplete="off">
                ...
                <div class="modal-footer">
                    <button class="btn btn-warning" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal"
                        data-bs-dismiss="modal">Lançar com nota em mãos</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="cd" oninput="verifica_chave();" action="<?php echo $action;?>" method="post">
                        ...
                        <input type="text" class="form-control" id="chaveNota" name="chave" maxlength="44" required
                            aria-describedby="ChaveHelpBlock" autofocus>
